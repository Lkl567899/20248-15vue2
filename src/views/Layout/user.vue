<template>
  <div class="user">
    ...
    <div class="address">
      <div class="item" @click="$router.push('/myorder?dataType=all')">
        <van-icon name="label-o" class="fs20" />
        <div class="temp">全部</div>
      </div>
      <div class="item" @click="$router.push('/myorder?dataType=payment')">
        <van-icon name="pending-payment" class="fs20" />
        <div class="temp">待支付</div>
      </div>
      <div class="item" @click="$router.push('/myorder?dataType=delivery')">
        <van-icon name="logistics" class="fs20" />
        <div class="temp">待发货</div>
      </div>
      <div class="item" @click="$router.push('/myorder?dataType=received')">
